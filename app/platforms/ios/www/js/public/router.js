...
$ionicConfigProvider.views.maxCache(10);
    ...
    $stateProvider
     ...
     .state('preview', {
      ...
      .state('tab.publish-saveInfoOk', {
        url: '/publish/saveInfoOk/:title-url_:url',
        views: {
          "tab-publish": {
      ...
      .state('tab.publish-toHire', {
        url: '/publish-toHire-:source-:id',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-toHire-JobDescription', {
        url: '/publish-toHire/JobDescription/:type',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-toHire-selectTmp', {
        url: '/publish-toHire/selectTmp/:type',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-toHire-selectTrade', {
        url: '/publish-toHire/selectTrade',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-toHire-yearlySalary', {
        url: '/publish-toHire/yearlySalary',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-toHire-jobCharacteristics', {
        url: '/publish-toHire/jobCharacteristics',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-toHire-preview', {
        url: '/publish-toHire/preview/:source/:id',
        views: {
          "tab-discover": {
     ...
     .state('tab.publish-activity-preview', {
        url: '/publish-activity/preview/:source/:id',
        views: {
          "tab-discover": {
    ...
    //发布->活动路由
    $stateProvider
      .state('tab.publish-activity', {
        url: '/publish-activity-:source-:id',
        views: {
          "tab-discover": {
...
/*       .state('tab.publish-activity-a', {
        url: '/publish-activity-circle-:id',
        views: {
          "tab-discover": {
            templateUrl: 'templates/publish/activity-index.html',
            controller: 'activity'
      ...
      .state('tab.publish-activity-selectType', {
        url: '/publish-activity/selectType',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-activity-selectType-b', {
       ...
       .state('tab.publish-activity-selectType-c', {
        url: '/circle-activity/selectType',
        views: {
          "tab-discover": {
            templateUrl: 'templates/public/selectType.html',
            controller: 'activitySelectType'
      ...
      .state('tab.publish-activity-additionalRegistration', {
        url: '/discover-activity/additionalRegistration',
        views: {
          "tab-discover": {
      ...
      .state('tab.publish-activity-teachingSatisfaction', {
        url: '/discover-activity/teachingSatisfaction',
        views: {
          "tab-discover": {
            templateUrl: 'templates/public/attachInfo.html',
       ...
       .state('tab.publish-activity-teachingSatisfaction-v', {
        url: '/public-activity/teachingSatisfaction',
        views: {
          "tab-discover": {
            templateUrl: 'templates/public/attachInfo.html',
            controller: 'activityTeachingSatisfaction'
      ...
      .state('tab.publish-activity-satisfaction', {
        url: '/discover-activity/satisfaction',
        views: {
          "tab-discover": {
            templateUrl: 'templates/public/attachInfo.html',
      ...
      .state('tab.publish-activity-saveInfoOk', {
        url: '/discover-activity/saveInfoOk',
        views: {
          "tab-discover": {
            templateUrl: 'templates/public/savePrompt.html',
   ...
   /*   .state('tab.publish-activity-preview', {
        url: '/discover-activity/preview/:source/:id',
        views: {
          "tab-discover": {
            templateUrl: 'templates/publish/activity-preview.html',
            controller: 'activityPreview'
...
*/
    ...
    //发布->信息路由
    $stateProvider
      .state('tab.publish-information', {
        url: '/publish-information-:source-:id',
        views: {
          "tab-circle": {
...
/*       .state('tab.publish-information', {
        url: '/publish-information-circle-:id',
        views: {
          "tab-circle": {
            templateUrl: 'templates/publish/information-index.html',
            controller: 'information'
      ...
      .state('tab.publish-information-selectType', {
        url: '/public-information/selectType',
        views: {
          "tab-circle": {
            templateUrl: 'templates/public/selectType.html',
      ...
      .state('tab.publish-information-preview', {
        url: '/publish-information/preview/:source/:id',
        views: {
          "tab-circle": {
...
/*      .state('tab.publish-investigate', {
        url: '/publish-investigate-circle-:id',
        views: {
          "tab-circle": {
            templateUrl: 'templates/publish/investigate-index.html',
            controller: 'investigate'
...
/*          }
    ...
    $stateProvider
     ...
     .state('tab.user-activity-selectType-b', {
        url: '/public-activity/selectType',
        views: {
          "tab-circle": {
            templateUrl: 'templates/public/selectType.html',
            controller: 'activitySelectType'
       ...
       .state('tab.user-activity-selectType-c', {
        url: '/publish-activity/selectType',
        views: {
          "tab-circle": {
            templateUrl: 'templates/public/selectType.html',
       ...
       .state('tab.user-activity-selectType-d', {
      ...
      .state('tab.user-activity-additionalRegistration-b', {
        url: '/public-activity/additionalRegistration',
        views: {
          "tab-discover": {
            templateUrl: 'templates/public/attachInfo.html',
            controller: 'activityAdditionalRegistration'
      ...
      .state('tab.user-activity-satisfaction', {
       ...
       .state('tab.user-activity-satisfaction-b', {
        url: '/public-activity/satisfaction',
        views: {
          "tab-user": {
            templateUrl: 'templates/public/attachInfo.html',
            controller: 'activitySatisfaction'
